...
//create books
exports.booksRouts.post("/", (req, res) =>
...
// get all books
exports.booksRouts.get("/", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const {
        filter,
...
//Get Book by ID
exports.booksRouts.get("/:bookId", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
// update books
exports.booksRouts.patch("/:bookId", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { bookId } = req.params;
      const updatedBody = req.body;
      const book = yield book_model_1.Book.findByIdAndUpdate(
        bookId,
        updatedBody,
        {
          new: true,
...
// delete books
exports.booksRouts.delete("/:bookId", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { bookId } = req.params;
